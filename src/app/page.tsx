        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <Link href="/login" className="group">
              <div className="cloudpeak-card p-8 backdrop-blur-xl bg-white/10 border border-white/20 hover:scale-105 transition-all duration-300 group-hover:shadow-2xl group-hover:bg-white/15">
                ...
                <p className="text-slate-300 mb-4">Pengurusan analisis sistem STRiKe</p>
            ...
            <Link href="/login" className="group">
              <div className="cloudpeak-card p-8 backdrop-blur-xl bg-white/10 border border-white/20 hover:scale-105 transition-all duration-300 group-hover:shadow-2xl group-hover:bg-white/15">
                ...
                <h3 className="text-xl font-semibold text-white mb-3">Pangkalan Data STRiKe</h3>
          ...
          <div className="text-center mt-16">
            <p className="text-slate-400 mb-4">
              Jemaah Nazir | Kementerian Pendidikan Malaysia 2025
            </p>
