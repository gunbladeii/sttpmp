          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            ...
            <Link href="/login" className="group">
              <div className="cloudpeak-card p-6 sm:p-8 backdrop-blur-xl bg-white/10 border border-white/20 hover:scale-105 transition-all duration-300 group-hover:shadow-2xl group-hover:bg-white/15">
                ...
                <h3 className="text-lg sm:text-xl font-semibold text-white mb-2 sm:mb-3">Perakuan Menteri</h3>
                <p className="text-sm sm:text-base text-slate-300 mb-3 sm:mb-4">Pengurusan Perakuan Menteri dan maklum balas</p>
